...
contract Ticle is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ticle", "$Ticle")  {
        rewardToken = 0xCc78A0acDF847A2C1714D2A925bB4477df5d48a6;
        _marketingWalletAddress = 0xE4f28743bA98c2B659B559c7fb91d276ed471443;// update marketing wallet
        ...
        uint256 totalSupply = 250000000000 * (10**18);
